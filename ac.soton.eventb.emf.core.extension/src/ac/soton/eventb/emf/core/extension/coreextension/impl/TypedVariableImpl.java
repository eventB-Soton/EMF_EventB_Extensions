...
import org.eventb.emf.core.machine.impl.VariableImpl;
...
public class TypedVariableImpl extends VariableImpl implements TypedVariable {
	...
	protected EClass eStaticClass() {
		return CoreextensionPackage.Literals.TYPED_VARIABLE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CoreextensionPackage.TYPED_VARIABLE__TYPE, oldType, type));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Type.class) {
			switch (baseFeatureID) {
				case CoreextensionPackage.TYPE__TYPE: return CoreextensionPackage.TYPED_VARIABLE__TYPE;
				default: return -1;
			}
		}
		if (baseClass == Value.class) {
